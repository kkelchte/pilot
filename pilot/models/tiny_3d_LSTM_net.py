...
import tinyv3_3d_net as tiny_net


class Net(nn.Module):

  def __init__(self, output_size = 10, pretrained=False, dropout=0, n_frames=3, **kwargs):
    super(Net, self).__init__()
    feature_network = tiny_net.Net(pretrained=pretrained, n_frames=n_frames)
    self.H=64
    self.L=2
