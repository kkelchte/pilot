...
def alexnet(inputs,
    ...
    end_point = 'fc_6'
    l6=tf.layers.conv1d(p5, filters=4096, kernel_size=1, strides=1, padding='valid', activation=tf.nn.relu, kernel_initializer=tf.contrib.layers.xavier_initializer(), name=end_point, reuse=reuse)
