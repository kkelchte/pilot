  ...
  with tf.variable_scope(scope, 'DepthQnet', reuse=reuse) as scope:
    with slim.arg_scope([slim.batch_norm, slim.dropout],
      ...
      with tf.variable_scope('q_coll'):
        ...
        q_coll_feat = tf.concat([tf.reshape(net,[-1, int(FLAGS.depth_multiplier*1024)]),actions],axis=1)
...
coll_q_net.default_image_size={}
coll_q_net.default_image_size[1] = 224
coll_q_net.default_image_size[0.5] = 160
coll_q_net.default_image_size[0.25] = 128
...
def coll_q_net_arg_scope(is_training=True,
