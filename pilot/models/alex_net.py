...
def alexnet(inputs,
    ...
    end_point = 'conv_1'
    l1=tf.layers.conv2d(inputs, 96, kernel_size=[11,11], strides=4, padding='valid', activation=tf.nn.sigmoid, kernel_initializer=tf.contrib.layers.xavier_initializer(), name=end_point, reuse=reuse)
    ...
    end_point = 'conv_2'
    l2=tf.layers.conv2d(p1, 256, kernel_size=[5,5], strides=1, padding='same', activation=tf.nn.sigmoid, kernel_initializer=tf.contrib.layers.xavier_initializer(), name=end_point, reuse=reuse)
    ...
    end_point = 'conv_3'
    l3=tf.layers.conv2d(p2, 384, kernel_size=[3,3], strides=1, padding='same', activation=tf.nn.sigmoid, kernel_initializer=tf.contrib.layers.xavier_initializer(), name=end_point, reuse=reuse)
    if verbose: print("shape l3: {}".format(l3.shape))
    end_points[end_point]=l3
    end_point = 'conv_4'
    l4=tf.layers.conv2d(l3, 384, kernel_size=[3,3], strides=1, padding='same', activation=tf.nn.sigmoid, kernel_initializer=tf.contrib.layers.xavier_initializer(), name=end_point, reuse=reuse)
    if verbose: print("shape l4: {}".format(l4.shape))
    end_points[end_point]=l4
    end_point = 'conv_5'
    l5=tf.layers.conv2d(l4, 256, kernel_size=[3,3], strides=1, padding='same', activation=tf.nn.sigmoid, kernel_initializer=tf.contrib.layers.xavier_initializer(), name=end_point, reuse=reuse)
    ...
    end_point = 'fc_6'
    l6=tf.layers.conv1d(reshaped_p5, filters=4096, kernel_size=1, strides=1, padding='valid', activation=tf.nn.sigmoid, kernel_initializer=tf.contrib.layers.xavier_initializer(), name=end_point, reuse=reuse)
    if verbose: print("shape l6: {}".format(l6.shape))
    end_points[end_point]=l6
    end_point = 'fc_7'
    l7=tf.layers.conv1d(l6, filters=4096, kernel_size=1, strides=1, padding='valid', activation=tf.nn.sigmoid, kernel_initializer=tf.contrib.layers.xavier_initializer(), name=end_point, reuse=reuse)
