...
# train $chapter/$section/vgg16_SGD_pretrained_normalized/final --pretrained --optimizer SGD --network vgg16_net --normalized_input  --gpumem_train 6000 --learning_rate 0.01
