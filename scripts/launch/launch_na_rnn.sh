...
pretrain(){
  cd ..
  condor_args_pretraining="--wall_time $((24*60*60)) --rammem 15 --load_data_in_ram"
...
train(){
  ...
  condor_args="--wall_time_train $((24*60*60)) --wall_time_eva $((30*60+5*5*60+30*60)) --rammem 15 --gpumem_eva 1800 --load_data_in_ram"
...
# pretrain $chapter/$section/tiny_LSTM_SBPTT/learning_rates --network tinyv3_LSTM_net  --subsample 5  --batch_size 5 --gpumem 1800 --time_length 20 --sliding_tbptt
