...
#   Tensorflow Settings
# ==========================
parser.add_argument("-pp","--python_project",default='ensemble_v2/pilot', type=str, help="Define in which python project the executable should be started with ~/tenorflow/PROJECT_NAME/main.py: q-learning/pilot, pilot/pilot, ddpg, ....")
