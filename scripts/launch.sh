...
# TODO # max_episodes?
python dag_train_and_evaluate.py -t all_factors/ensemble_imgnet --wall_time_train $((12*60*60)) --wall_time_eva $((60*60)) --rammem 20 --number_of_models 1 --loss mse --non_expert_weight 1 --load_data_in_ram --normalize_over_actions --learning_rate 0.1 --dataset all_factors --max_episodes 1000 --network mobile --discrete --visualize_deep_dream_of_output --visualize_saliency_of_output --histogram_of_weights --histogram_of_activations --paramfile eva_params.yaml --number_of_runs 6 -w corridor -w esatv1 --reuse_default_world --robot drone_sim --fsm oracle_nn_drone_fsm --evaluation --speed 1.3 
python dag_train_and_evaluate.py -t all_factors/ensemble_smce_1 --wall_time_train $((12*60*60)) --wall_time_eva $((60*60)) --rammem 20 --number_of_models 1 --loss smce                   --load_data_in_ram --normalize_over_actions --learning_rate 0.1 --dataset all_factors --max_episodes 1000 --network mobile --discrete --scratch --visualize_deep_dream_of_output --visualize_saliency_of_output --histogram_of_weights --histogram_of_activations --paramfile eva_params.yaml --number_of_runs 6 -w corridor -w esatv1 --reuse_default_world --robot drone_sim --fsm oracle_nn_drone_fsm --evaluation --speed 1.3 
