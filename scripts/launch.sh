...
python dag_train_and_evaluate.py -t dynamic_ensemble/image/squeeze_v1   --gpumem 2600 --wall_time_train $((7*60*60)) --wall_time_eva $((2*60*60)) --number_of_models 3 --loss mse --discriminator_input image --non_expert_weight 0 --load_data_in_ram --learning_rate 0.05 --dataset all_factors --max_episodes 1000 --network squeeze_v1 --discrete --scratch --visualize_deep_dream_of_output --visualize_saliency_of_output --paramfile eva_params.yaml --number_of_runs 10 -w corridor -w esatv1 --reuse_default_world --robot drone_sim --fsm oracle_nn_drone_fsm --evaluation --speed 1.3 
python dag_train_and_evaluate.py -t dynamic_ensemble/image/squeeze_v3   --gpumem 2600 --wall_time_train $((7*60*60)) --wall_time_eva $((2*60*60)) --number_of_models 3 --loss mse --discriminator_input image --non_expert_weight 0 --load_data_in_ram --learning_rate 0.05 --dataset all_factors --max_episodes 1000 --network squeeze_v3 --discrete --scratch --visualize_deep_dream_of_output --visualize_saliency_of_output --paramfile eva_params.yaml --number_of_runs 10 -w corridor -w esatv1 --reuse_default_world --robot drone_sim --fsm oracle_nn_drone_fsm --evaluation --speed 1.3 
...
python dag_train_and_evaluate.py -t dynamic_ensemble/image/alex_v4   --gpumem 4600 --wall_time_train $((3*60*60)) --wall_time_eva $((2*60*60)) --number_of_models 3 --loss mse --discriminator_input image --non_expert_weight 0 --load_data_in_ram --learning_rate 0.05 --dataset all_factors --max_episodes 1000 --network tiny --discrete --scratch --visualize_deep_dream_of_output --visualize_saliency_of_output --paramfile eva_params.yaml --number_of_runs 10 -w corridor -w esatv1 --reuse_default_world --robot drone_sim --fsm oracle_nn_drone_fsm --evaluation --speed 1.3 
