...
python dag_train_and_evaluate.py -t LLL_doshico_final/sandbox --wall_time_train $((3*60*60)) --wall_time_eva $((1*60*60)) --number_of_models 2 --network tiny_v2 --batch_size 64 --learning_rate 0.001 --optimizer gradientdescent --dataset LLL_doshico_sandbox --max_episodes 100 --discrete --update_importance_weights --paramfile eva_params.yaml --number_of_runs 5 --robot drone_sim --fsm oracle_nn_drone_fsm --evaluation --speed 1.3 -w sandbox

# STEP 2A: train set initialized on forest on canyon with and without lifelonglearning and test in canyon and forest
# python dag_train_and_evaluate.py -t LLL_doshico/forest_canyon_lr0001/LL_10 --wall_time_train $((4*60*60)) --wall_time_eva $((3*60*60)) --number_of_models 1 --batch_size 64 --load_data_in_ram --load_config --continue_training --learning_rate 0.0001 --optimizer gradientdescent --dataset doshico_drone_forest_canyon --max_episodes 500 --checkpoint_path LLL_doshico/forest_g/0/2018-10-30_1046 --update_importance_weights --lifelonglearning --lll_weight 10 --paramfile eva_params.yaml --number_of_runs 6 --robot drone_sim --fsm oracle_nn_drone_fsm --evaluation --speed 1.3  -w forest -w canyon
...
# python dag_train_and_evaluate.py -t LLL_doshico/forest_sandbox_lr0001/LL_10 --wall_time_train $((4*60*60)) --wall_time_eva $((3*60*60)) --number_of_models 1 --batch_size 64 --load_data_in_ram --load_config --continue_training --learning_rate 0.0001 --optimizer gradientdescent --dataset doshico_drone_forest_sandbox --max_episodes 500 --checkpoint_path LLL_doshico/forest_g/0/2018-10-30_1046 --update_importance_weights --lifelonglearning --lll_weight 10 --paramfile eva_params.yaml --number_of_runs 6 --robot drone_sim --fsm oracle_nn_drone_fsm --evaluation --speed 1.3  -w forest -w sandbox
