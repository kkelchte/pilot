...
# python dag_train_and_evaluate.py -t dynamic_ensemble_10_empty_uni/image_frozen/mobile_imgnet --wall_time_train $((5*60*60)) --wall_time_eva $((2*60*60)) --number_of_models 10 --loss mse --checkpoint_path static_ensemble_10_empty_uni/mobile_imgnet/1 --discriminator_input image --non_expert_weight 0 --learning_rate 0.05 --dataset all_factors_empty_uni --max_episodes 200 --network mobile --discrete            --visualize_deep_dream_of_output --visualize_saliency_of_output --paramfile eva_params.yaml --number_of_runs 10 -w corridor -w esatv1 --reuse_default_world --robot drone_sim --fsm oracle_nn_drone_fsm --evaluation --speed 1.3 
# python dag_train_and_evaluate.py -t dynamic_ensemble_10_empty_uni_ou/image_frozen/mobile_imgnet --wall_time_train $((5*60*60)) --wall_time_eva $((2*60*60)) --number_of_models 10 --loss mse --checkpoint_path static_ensemble_10_empty_uni_ou/mobile_imgnet/1 --discriminator_input image --non_expert_weight 0 --learning_rate 0.05 --dataset all_factors_empty_uni_ou --max_episodes 200 --network mobile --discrete            --visualize_deep_dream_of_output --visualize_saliency_of_output --paramfile eva_params.yaml --number_of_runs 10 -w corridor -w esatv1 --reuse_default_world --robot drone_sim --fsm oracle_nn_drone_fsm --evaluation --speed 1.3 

# python dag_train_and_evaluate.py -t dynamic_ensemble/image/mobile_scratch --wall_time_train $((3*60*60)) --wall_time_eva $((2*60*60)) --number_of_models 3 --loss mse --discriminator_input image --non_expert_weight 0 --load_data_in_ram --learning_rate 0.05 --dataset all_factors --max_episodes 1000 --network mobile --discrete --scratch --visualize_deep_dream_of_output --visualize_saliency_of_output --paramfile eva_params.yaml --number_of_runs 10 -w corridor -w esatv1 --reuse_default_world --robot drone_sim --fsm oracle_nn_drone_fsm --evaluation --speed 1.3 
# python dag_train_and_evaluate.py -t dynamic_ensemble/image/mobile_imgnet --wall_time_train $((3*60*60)) --wall_time_eva $((2*60*60)) --number_of_models 10 --loss mse --discriminator_input image --non_expert_weight 0 --load_data_in_ram --learning_rate 0.05 --dataset all_factors --max_episodes 1000 --network mobile --discrete            --visualize_deep_dream_of_output --visualize_saliency_of_output --paramfile eva_params.yaml --number_of_runs 10 -w corridor -w esatv1 --reuse_default_world --robot drone_sim --fsm oracle_nn_drone_fsm --evaluation --speed 1.3 
# python dag_train_and_evaluate.py -t dynamic_ensemble/image/tiny   --wall_time_train $((3*60*60)) --wall_time_eva $((2*60*60)) --number_of_models 3 --loss mse --discriminator_input image --non_expert_weight 0 --load_data_in_ram --learning_rate 0.05 --dataset all_factors --max_episodes 1000 --network tiny --discrete --scratch --visualize_deep_dream_of_output --visualize_saliency_of_output --paramfile eva_params.yaml --number_of_runs 10 -w corridor -w esatv1 --reuse_default_world --robot drone_sim --fsm oracle_nn_drone_fsm --evaluation --speed 1.3 

# python dag_train.py -t dynamic_ensemble/feature/tiny_CAM --wall_time_train $((7*60*60)) --wall_time_eva $((2*60*60)) --number_of_models 3 --loss mse --discriminator_input feature --non_expert_weight 0 --load_data_in_ram --learning_rate 0.05 --dataset all_factors --max_episodes 1000 --network tiny_CAM --discrete --scratch --visualize_deep_dream_of_output --visualize_saliency_of_output --visualize_control_activation_maps
# python dag_train.py -t dynamic_ensemble/image/tiny_CAM --wall_time_train $((7*60*60)) --wall_time_eva $((2*60*60)) --number_of_models 3 --loss mse --discriminator_input image --non_expert_weight 0 --load_data_in_ram --learning_rate 0.05 --dataset all_factors --max_episodes 1000 --network tiny_CAM --discrete --scratch --visualize_deep_dream_of_output --visualize_saliency_of_output --visualize_control_activation_maps

# for i in $(seq 0 9) ;  do
#   python dag_train_and_evaluate.py -t dynamic_ensemble_10_frozen_ou/image/mobile_imgnet/$i --wall_time_train $((7*60*60)) --wall_time_eva $((2*60*60)) --checkpoint_path static_ensemble_10_ou/mobile_imgnet/$i --number_of_models 1 --loss mse --discriminator_input image --non_expert_weight 0 --load_data_in_ram --learning_rate 0.05 --dataset all_factors_ou --discrete --max_episodes 1000 --visualize_deep_dream_of_output --visualize_saliency_of_output --paramfile eva_params.yaml --number_of_runs 10 -w corridor -w esatv1 --reuse_default_world --robot drone_sim --fsm oracle_nn_drone_fsm --evaluation --speed 1.3  
#   python dag_train_and_evaluate.py -t dynamic_ensemble_10_frozen_uni/image/mobile_imgnet/$i --wall_time_train $((7*60*60)) --wall_time_eva $((2*60*60)) --checkpoint_path static_ensemble_10_uni/mobile_imgnet/$i --number_of_models 1 --loss mse --discriminator_input image --non_expert_weight 0 --load_data_in_ram --learning_rate 0.05 --dataset all_factors_uni --discrete --max_episodes 1000 --visualize_deep_dream_of_output --visualize_saliency_of_output --paramfile eva_params.yaml --number_of_runs 10 -w corridor -w esatv1 --reuse_default_world --robot drone_sim --fsm oracle_nn_drone_fsm --evaluation --speed 1.3	
# done
