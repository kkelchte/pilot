...
# OLD
# python dag_train_and_evaluate.py -t canyon_drone_discrete --wall_time_train $((5*60*60)) --wall_time_eva $((2*60*60)) --number_of_models 5 --learning_rate 0.01 --dataset canyon_drone --max_episodes 500 --paramfile eva_params.yaml --number_of_runs 10 -w canyon --robot drone_sim --fsm oracle_nn_drone_fsm --discrete --grad_mul_weight 1 --evaluation --network mobile --no_batchnorm_learning --speed 1.3
# python dag_train_and_evaluate.py -t forest_drone_discrete --wall_time_train $((5*60*60)) --wall_time_eva $((2*60*60)) --number_of_models 5 --learning_rate 0.01 --dataset forest_drone --max_episodes 500 --paramfile eva_params.yaml --number_of_runs 10 -w forest --robot drone_sim --fsm oracle_nn_drone_fsm --discrete --grad_mul_weight 1 --evaluation --network mobile --no_batchnorm_learning --speed 1.3
# python dag_train_and_evaluate.py -t sandbox_drone_discrete --wall_time_train $((5*60*60)) --wall_time_eva $((2*60*60)) --number_of_models 5 --learning_rate 0.01 --dataset sandbox_drone --max_episodes 500 --paramfile eva_params.yaml --number_of_runs 10 -w sandbox --robot drone_sim --fsm oracle_nn_drone_fsm --discrete --grad_mul_weight 1 --evaluation --network mobile --no_batchnorm_learning --speed 1.3

# python dag_train_and_evaluate.py -t canyon_drone_discrete --wall_time_train $((5*60*60)) --wall_time_eva $((2*60*60)) --number_of_models 5 --learning_rate 0.001 --dataset canyon_drone --max_episodes 500 --paramfile eva_params.yaml --number_of_runs 10 -w canyon --robot drone_sim --fsm oracle_nn_drone_fsm --discrete --evaluation --network mobile --no_batchnorm_learning --speed 1.3
# python dag_train_and_evaluate.py -t forest_drone_discrete --wall_time_train $((5*60*60)) --wall_time_eva $((2*60*60)) --number_of_models 5 --learning_rate 0.001 --dataset forest_drone --max_episodes 500 --paramfile eva_params.yaml --number_of_runs 10 -w forest --robot drone_sim --fsm oracle_nn_drone_fsm --discrete --evaluation --network mobile --no_batchnorm_learning --speed 1.3
# python dag_train_and_evaluate.py -t sandbox_drone_discrete --wall_time_train $((5*60*60)) --wall_time_eva $((2*60*60)) --number_of_models 5 --learning_rate 0.001 --dataset sandbox_drone --max_episodes 500 --paramfile eva_params.yaml --number_of_runs 10 -w sandbox --robot drone_sim --fsm oracle_nn_drone_fsm --discrete --evaluation --network mobile --no_batchnorm_learning --speed 1.3
