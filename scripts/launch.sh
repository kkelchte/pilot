...
# python dag_train_and_evaluate.py -t LLL_doshico_final/sandbox --wall_time_train $((30*60*60)) --wall_time_eva $((1*60*60)) --number_of_models 2 --network tiny_v2 --batch_size 64 --learning_rate 0.001 --optimizer gradientdescent --dataset LLL_doshico_sandbox --max_episodes 1000 --discrete --update_importance_weights --paramfile eva_params.yaml --number_of_runs 5 --robot drone_sim --fsm oracle_nn_drone_fsm --evaluation --speed 1.3 -w sandbox
