...
# not on qayd nor on gluster, you have to make the job first visit
# the directory in which the image is saved and start singularity from there.

# echo "exec $1 in singularity image /esat/qayd/kkelchte/singularity_images/ros_gazebo_tensorflow_xpra.img"
# ls /esat/qayd/kkelchte/singularity_images/
# sleep 0.1
# /usr/bin/singularity exec --nv /esat/qayd/kkelchte/singularity_images/ros_gazebo_tensorflow_xpra.img $1
