...
COMMAND=(./scripts/${SCRIPT} -s start_python_sing.sh -g false)
...
echo "transfer_input_files = /esat/opal/kkelchte/docker_home/tensorflow/pilot/scripts/prescript_sing.sh,/esat/opal/kkelchte/docker_home/tensorflow/pilot/scripts/postscript_sing.sh" >> $condor_file
...
# echo "Initialdir       = /esat/opal/kkelchte/docker_home/tensorflow/pilot/scripts"   >> $condor_file
# echo "Executable       = /usr/bin/singularity" >> $condor_file
echo "Executable       = $sing_file" >> $condor_file
# echo "Executable       = /esat/opal/kkelchte/docker_home/tensorflow/pilot/scripts/start_singularity.sh" >> $condor_file
