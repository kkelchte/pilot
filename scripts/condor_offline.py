...
executable.write("export PYTHONPATH=/users/visics/kkelchte/tensorflow_1.8/lib/python2.7/site-packages:{0}/tensorflow/{1}:{0}/tenorflow/pytorch-cnn-visualizations/src\n".format(FLAGS.home, FLAGS.python_project+'/..'))
