...
# command="python condor_offline.py -t {0}/results --dont_submit -pp pytorch_pilot/scripts -ps get_results.py --mother_dir {0} --endswith _eva --home {1} --wall_time {2}".format(FLAGS.log_tag, FLAGS.home, 10*60)
# for e in others: command=" {0} {1}".format(command, e)
# save_call(command)
