...
for model in naive_ensemble/mobile_scratch/0 ; do
    ...
    python run_script.py -t testing -pe sing -pp pilot/pilot -m $model -w corridor --reuse_default_world -p eva_params.yaml -n 1 --robot drone_sim --fsm oracle_nn_drone_fsm -e -g
