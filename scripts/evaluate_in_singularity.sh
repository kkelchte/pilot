...
# for model in varied_corridor/mobile ; do
    ...
    python run_script.py -t ${model}_eva -pe sing -pp pilot/pilot -m $model -w corridor -w esatv1 --reuse_default_world -p eva_params.yaml -n 10 --robot drone_sim --fsm oracle_nn_drone_fsm -e -g
