...
for model in varied_corridor/mobile ; do
    ...
    python run_script.py -t testing -pe sing -pp pilot/pilot -m $model -w $world --reuse_default_world -p eva_params.yaml -n 1 --robot drone_sim --fsm oracle_nn_drone_fsm -e -g
